...
const PrivacyPolicy = () => {
  const sections = [
    ...
    },
    {
      ...
      list: [
        "Order and transaction data: retained as required for accounting, tax, and legal compliance",
        "Account and profile data: retained until you close your account or request deletion",
        "Marketing and communication preferences: retained until you unsubscribe or withdraw consent",
    ...
    },
    {
      icon: CheckCircle2,
      title: "Your Rights",
      content: "You can request data deletion or modification by contacting us at dyma.infotech.dipl@gmail.com."
    },
    {
      icon: Mail,
      title: "Contact Us",
