...
const MobileBottomNav = () => {
  ...
  const allCategories = [
    { icon: Footprints, name: "Men's Shoes", link: "/category/Men's%20Shoes", subcategories: ["Formal", "Boots", "Loafers", "Sandals"] },
    { icon: Footprints, name: "Women's Shoes", link: "/category/Women's%20Shoes", subcategories: ["Heels", "Flats", "Boots", "Sandals", "Chappals"] },
